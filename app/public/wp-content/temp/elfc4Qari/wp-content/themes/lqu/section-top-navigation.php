	...
	<nav>
		<ul class="left">
			...
			<li class="text-link desktop-link">
				<span>
					<span>Custom</span> <span>Furniture</span>
				</span>
				<ul>
					<li><a href="/product-category/custom-furniture/chairs/">Chairs</a></li>
					<li><a href="/product-category/custom-furniture/chaises/">Chaises</a></li>
					<li><a href="/product-category/custom-furniture/dining-chairs/">Dining Chairs</a></li>
					<li><a href="/product-category/custom-furniture/headboards/">Headboards</a></li>
					<li><a href="/product-category/custom-furniture/ottomans/">Ottomans</a></li>
					<li><a href="/product-category/custom-furniture/slipper-chairs/">Slipper Chairs</a></li>
					<li><a href="/product-category/custom-furniture/sofas/">Sofas</a></li>
					<li><a href="/product-category/custom-furniture/wood-finishes/">Wood Finishes</a></li>
				</ul>
			</li>
			...
			<li class="text-link desktop-link">
				<a href="/product-category/draperies/"><span>Draperies</span></a>
			</li>
			<li class="text-link desktop-link">
				<a href="/product-category/readytosell/"><span>Shop</span></a>
			</li>
		</ul>
