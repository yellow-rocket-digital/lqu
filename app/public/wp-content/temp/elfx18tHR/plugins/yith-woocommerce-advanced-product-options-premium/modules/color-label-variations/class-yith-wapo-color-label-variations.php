...
if ( ! class_exists( 'YITH_WAPO_Color_Label_Variations' ) ) {
	...
	class YITH_WAPO_Color_Label_Variations {
		...
		public static function get_custom_attribute_types() {
			return array(
				'colorpicker' => __( 'Color picker', 'yith-woocommerce-product-add-ons' ),
				'image'       => __( 'Image', 'yith-woocommerce-product-add-ons' ),
				'label'       => __( 'Label', 'yith-woocommerce-product-add-ons' ),
			);
		}
