...
?>
        ...
        <div class="ajax-filelist" style="<?php echo (!empty($this->options['maxheight'])) ? 'max-height:'.$this->options['maxheight'].';overflow-y: scroll;overflow-x: hidden;' : ''; ?>">
            <div class='files'>
                <div class="folders-container"><?php \TheLion\ShareoneDrive\Skeleton::get_browser_placeholders('folder', 3); ?></div>
                <div class="files-container"><?php \TheLion\ShareoneDrive\Skeleton::get_browser_placeholders('file', 5); ?></div>
            </div>
        </div>
