                    ...
                    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="border-t border-gray-200 py-4 text-sm text-gray-500 text-center sm:text-left">
                            <span class="block sm:inline">
                                <?php echo AdminLayout::render_notice(esc_html__('Please note that the embedded files do have the public sharing permission [anyone with link can view]. Google Docs can also be embedded in "Edit" mode. The sharing permissions are set to [anyone with link can edit].', 'wpcloudplugins'), 'info'); ?>
                            </span>
                        </div>
                    </div>
                </footer>
