 ...
 * when updating the plugin. Instead, use the 'shareonedrive_set_lost_authorization_template' filter
 * to modify the location of the template that needs to be used.
 *
 * E.g.
 *
 * add_filter('shareonedrive_set_lost_authorization_template','change_lost_authorization_template', 10, 1);
 *
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:600px;">
                                                            <img alt="" height="auto" src="<?php echo SHAREONEDRIVE_ROOTPATH; ?>/templates/notifications/images/support_header.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="600">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                                                    <p>The
                                                                        <strong>Share-one-Drive
                                                                        </strong> plugin on
                                                                        <a href="<?php echo get_site_url(); ?>">
                                                                            <?php echo get_site_url(); ?>
                                                                        </a> is not able to refresh access to the OneDrive <strong><?php echo !empty($account) ? '('.$account->get_email().'- ID: '.$account->get_id().')' : ''; ?></strong>. Please relink the plugin to your account by visiting the Admin Dashboard.
                                                                    </p>
                                                                    <p>In case you are not able to reauthorize the plugin, please check the status of the Microsoft Azure Active Directory service via
                                                                        <a href="https://status.azure.com">https://status.azure.com</a> and
                                                                        <a href="https://twitter.com/AzureSupport">https://twitter.com/AzureSupport</a>.
                                                                    </p>
                                                                    <br />
                                                                    <p>Kind regards,
                                                                        <br />
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:300px;line-height:100%;">
                                                                    <tr>
                                                                        <td align="center" bgcolor="#5e6ebf" role="presentation" style="border:none;border-radius:3px;cursor:auto;padding:10px 25px;background:<?php echo $colors['accent']; ?>;" valign="middle">
                                                                            <a href="<?php echo get_admin_url(null, 'admin.php?page=ShareoneDrive_settings_dashboard'); ?>" style="background:<?php echo $colors['accent']; ?>;color:#ffffff;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:17px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank">
                                                                                ❱❱❱
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td style="width:250px;">
                                                                                                                <a href="https://www.wpcloudplugins.com/">
                                                                                                                    <img alt="" height="auto" src="<?php echo SHAREONEDRIVE_ROOTPATH; ?>/css/images/wpcloudplugins-logo-dark.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="250">
                                                                                                                </a>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </tbody>
