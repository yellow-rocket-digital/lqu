...
?><div id="wpcp" class="wpcp-app hidden">
    <div class="absolute z-10 inset-0 bg-gray-100">
        ...
        <div class="font-sans flex w-64 flex-col fixed md:bottom-0 md:top-8">
            ...
            <div class="flex-1 flex flex-col min-h-0 bg-brand-color-900">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="mt-4">
                                                                    <div class="-mx-2 -my-1.5 flex">
                                                                        <a href="https://1.envato.market/yDbyv" class="bg-red-50 px-2 py-1.5 rounded-md text-sm font-medium text-red-800 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red-50 focus:ring-red-600" target="_blank"><?php esc_html_e('Renew here.', 'wpcloudplugins'); ?></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
AdminLayout::render_simple_textbox([
    ...
    'description' => sprintf(esc_html__('Sign up for %s and %s get your Access Token%s.', 'wpcloudplugins'), 'Bitly', "<a href='http:// bitly.com/a/your_api_key' target='_blank' class='wpcp-link-primary'>", '</a>'),
    'placeholder' => '',
    'default' => '',
    'key' => 'bitly_apikey',
]);
...
AdminLayout::render_wpeditor(
    [
        'title' => esc_html__('Template for %filelist%', 'wpcloudplugins'),
...
AdminLayout::render_user_selectbox([
    'title' => '',
    'description' => esc_html__('Select which roles or user should be able to access the plugin settings page.', 'wpcloudplugins'),
...
AdminLayout::render_user_selectbox([
    'title' => '',
    'description' => esc_html__('Select which roles or user should be able to manually link users to their private folder.', 'wpcloudplugins'),
...
AdminLayout::render_user_selectbox([
    'title' => '',
    'description' => esc_html__('Select which roles or user should be able to access event reports and statistics.', 'wpcloudplugins'),
...
AdminLayout::render_user_selectbox([
    'title' => '',
    'description' => esc_html__('Select which roles or user should be able to access file browser in the Admin Dashboard.', 'wpcloudplugins'),
...
AdminLayout::render_open_panel([
    'title' => esc_html__('Add Plugin Modules', 'wpcloudplugins'),
    'accordion' => true,
]);

AdminLayout::render_user_selectbox([
    'title' => '',
    'description' => esc_html__('Select which roles or user should be able to add and create modules.', 'wpcloudplugins'),
...
AdminLayout::render_user_selectbox([
    'title' => '',
    'description' => esc_html__('Select which roles or user should be able to add shared links to documents on your pages and posts.', 'wpcloudplugins'),
...
AdminLayout::render_user_selectbox([
    'title' => '',
    'description' => esc_html__('Select which roles or user should be able to embedded documents on your pages and posts.', 'wpcloudplugins'),
