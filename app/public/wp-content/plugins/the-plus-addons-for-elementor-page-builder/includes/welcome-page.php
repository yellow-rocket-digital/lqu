		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">May 10, 2023 <span class="changelog-version">Lite Version 5.2.3</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Accordion : Document Link Update','tpebl').'</li>';							
							echo '<li>'.esc_html__('Update : Advanced Text Block : Document Link Update','tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">May 10, 2023 <span class="changelog-version">Pro Version 5.2.5</span></div>';
						echo '<ul class="changelog-list">';	
