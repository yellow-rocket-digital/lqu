		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">April 5, 2023 <span class="changelog-version">Lite Version 5.2.0</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Update : Team Member : Controller Improvement','tpebl').'</li>';					
							echo '<li>'.esc_html__('Update : Equal Height : Js & Condition Improvement','tpebl').'</li>';							
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">April 5, 2023 <span class="changelog-version">Pro Version 5.2.0</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Update : Team Member : Controller Improvement','tpebl').'</li>';
							echo '<li>'.esc_html__('Upadte : Equal Height : Js & Condition Improvement','tpebl').'</li>';
							echo '<li>'.esc_html__('Update : Search Filter : Compatibility With Equal Height','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
