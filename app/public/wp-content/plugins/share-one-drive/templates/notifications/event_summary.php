 ...
 * when updating the plugin. Instead, use the 'shareonedrive_events_set_summary_template' filter
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:600px;">
                                                            <img alt="" height="auto" src="<?php echo SHAREONEDRIVE_ROOTPATH; ?>/templates/notifications/images/event_summary_header.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="600">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                                                    <?php
                                        echo sprintf(esc_html__('This is the latest summary of all the activities that are logged since %s', 'wpcloudplugins'), '<em>'.date_i18n('l j F '.get_option('time_format'), date_format($since, 'U')).'</em>');
?>.
                                                                </div>
                                                            </td>
                                                        </tr>
        ...
        break;
                                                                    ...
                                                                    <tr style="<?php echo ($current % 2) ? 'background: #f4f4f4;' : ''; ?> height: 35px;">
                                                                        ...
                                                                        <td style="line-height:25px;">
                                                                            <a href="https://onedrive.live.com/?id=<?php echo $entry['entry_id']; ?>" target="_blank">
...
if ($total - $max_events > 0) {
    echo sprintf(esc_html__('View more activities (%s left)', 'wpcloudplugins'), $total - $max_events);
} else {
    esc_html_e('View all activities', 'wpcloudplugins');
}
?>
                                                                            </a>
                                                                        </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center" style="font-size:0px;padding:10px 25px;padding-top:20px;word-break:break-word;">
                                                                                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#000000;">You can change the frequency of this email or turn it on and off by visiting your
                                                                                                    <a href="<?php echo get_admin_url(null, 'admin.php?page=ShareoneDrive_settings#settings_stats'); ?>">Share-one-Drive options
                                                                                                    </a> page.
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
