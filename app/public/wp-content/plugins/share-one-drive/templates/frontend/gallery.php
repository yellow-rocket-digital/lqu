      ...
      ?>
        ...
        <div class="tippy-content-holder sort-div">
            <ul class='nav-sorting-list'>
                ...
                <li><a class="nav-sorting-field nav-datetaken <?php echo ('datetaken' === $this->options['sort_field']) ? 'sort-selected' : ''; ?>" data-field="datetaken" title="<?php esc_html_e('Date of creation', 'wpcloudplugins'); ?>">
...
<style>
  ...
  #ShareoneDrive-<?php echo Processor::instance()->get_listtoken(); ?>.wpcp-gallery .image-collage {
  ...
  #ShareoneDrive-<?php echo Processor::instance()->get_listtoken(); ?>.wpcp-gallery .image-container {
    border-radius: <?php echo Processor::instance()->get_shortcode_option('border_radius'); ?>px !important;
  }
  #ShareoneDrive-<?php echo Processor::instance()->get_listtoken(); ?> .entry-top-actions{
