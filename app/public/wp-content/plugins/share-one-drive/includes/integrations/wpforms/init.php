...
class WPForms_Field_Upload_Box extends \WPForms_Field
{
    public function init()
    {
        ...
        $this->name = 'OneDrive';
        $this->type = 'wpcp-shareonedrive-upload-box';
    ...
    public function html_field_value($value, $field, $form_data, $type)
    {
        ...
        return apply_filters('shareonedrive_render_formfield_data', $value, $ashtml, $this);
    }
    ...
    // Enqueue Share-one-Drive scripts
    ...
    public function field_options($field)
    {
        ...
        $btn = $this->custom_option_field(
            ...
            [
                ...
                'class' => 'button shareonedrive open-shortcode-builder',
        ...
        $fld = $this->field_element(
            ...
            [
                ...
                'name' => 'shortcode',
                'rows' => 5,
                'value' => isset($field['shortcode']) ? $field['shortcode'] : '[shareonedrive mode="upload" upload="1" uploadrole="all" upload_auto_start="0" userfolders="auto" viewuserfoldersrole="none"]',
            ],
            false
        );
...
new \TheLion\ShareoneDrive\WPForms_Field_Upload_Box();
