...
<tr>
    ...
    <td>
        ...
        <a href="#" class='button-primary shareonedrive open-shortcode-builder'><?php esc_html_e('Build your shortcode', 'wpcloudplugins'); ?></a>
    </td>
</tr>
<?php
    }
...
<?php
    ...
    {
        return apply_filters('shareonedrive_render_formfield_data', $json_data, $ashtml, $this);
    }
    ...
    public function enqueue()
    {
        ...
        wp_enqueue_script('WPCP-'.$this->field_type.'-FormidableForms', plugins_url('FormidableForms.js', __FILE__), ['ShareoneDrive.UploadBox', 'ShareoneDrive'], SHAREONEDRIVE_VERSION, true);
    }
