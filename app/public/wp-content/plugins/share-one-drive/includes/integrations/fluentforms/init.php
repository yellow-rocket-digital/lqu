...
{
    public $default_value = '[shareonedrive mode="upload" upload="1" uploadrole="all" upload_auto_start="0" userfolders="auto" viewuserfoldersrole="none"]';
    public $field_type = 'wpcp-shareonedrive';
    ...
    public function __construct()
    {
        parent::__construct(
            $this->field_type,
            'OneDrive',
            ['cloud', 'onedrive', 'drive', 'documents', 'files', 'upload', 'video', 'audio', 'media', 'embed'],
...
<?php
    ...
    public function renderResponse($response, $field, $form_id)
    {
        ...
        return apply_filters('shareonedrive_render_formfield_data', $response, $ashtml, $this);
    }
    ...
    public function enqueueEditorAssets()
    {
        ...
        wp_enqueue_script('WPCP-'.$this->field_type.'-FluentForms', plugins_url('FluentForms.js', __FILE__), ['WPCloudplugin.Libraries'], SHAREONEDRIVE_VERSION, true);
    }
