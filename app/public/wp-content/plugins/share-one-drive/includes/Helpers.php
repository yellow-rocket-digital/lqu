...
class Helpers
{
    ...
    public static function get_all_users_and_roles()
    {
        ...
        foreach ($users as $wp_user) {
            ...
            $list[] = [
                ...
                'img' => ($user_count < 1000) ? get_avatar_url($wp_user->id, ['size' => '32']) : SHAREONEDRIVE_ROOTPATH.'/css/images/usericon.png',
            ];
    ...
    public static function apply_placeholders($value, $context = null, $extra = [])
    {
        ...
        $value = strtr($value, [
            ...
            '%ip%' => self::get_user_ip(),
            '%directory_separator%' => '/',
            '%uniqueID%' => get_option('share_one_drive_uniqueID', 0),
        ]);
        ...
        return apply_filters('shareonedrive_apply_placeholders', $value, $context, $extra);
    }
    ...
    public static function get_default_icon($mimetype, $is_dir = false)
    {
        ...
        return SHAREONEDRIVE_ICON_SET.'32x32/'.$icon.'.png';
    }
    ...
    public static function encrypt($data)
    {
        ...
        $first_encrypted = openssl_encrypt($data, $method, SHAREONEDRIVE_AUTH_KEY, OPENSSL_RAW_DATA, $iv);
    ...
    public static function decrypt($input)
    {
        ...
        return openssl_decrypt($first_encrypted, $method, SHAREONEDRIVE_AUTH_KEY, OPENSSL_RAW_DATA, $iv);
    }
