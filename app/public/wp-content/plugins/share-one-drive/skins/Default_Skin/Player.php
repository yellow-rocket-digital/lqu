...
class Default_Skin extends \TheLion\ShareoneDrive\MediaplayerSkin
{
    public $url;
    ...
    public function load_scripts()
    {
        ...
        wp_register_script('Default_Skin.Library', $this->get_url().'/js/mediaelement-and-player.min.js', $dependence, SHAREONEDRIVE_VERSION);
        wp_register_script('ShareoneDrive.Default_Skin.Player', $this->get_url().'/js/Player.js', ['Default_Skin.Polyfill', 'Default_Skin.Library', 'WPCloudplugin.Libraries'], SHAREONEDRIVE_VERSION, true);

        wp_enqueue_script('ShareoneDrive.Default_Skin.Player');
        ...
        wp_localize_script('ShareoneDrive.Default_Skin.Player', 'Default_Skin_vars', $localize_mediaplayer);
    }
    ...
    public function load_styles()
    {
        ...
        wp_register_style('ShareoneDrive.Default_Skin.Player.CSS', $this->get_url().'/css/style'.$is_rtl_css.'.css', false, SHAREONEDRIVE_VERSION);
        wp_enqueue_style('ShareoneDrive.Default_Skin.Player.CSS');
    }
}
