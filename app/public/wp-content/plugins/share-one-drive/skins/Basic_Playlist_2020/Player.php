...
class Basic_Playlist_2020 extends \TheLion\ShareoneDrive\MediaplayerSkin
{
    public $url;
    ...
    public function load_scripts()
    {
        ...
        wp_register_script('Basic_Playlist.Library', $this->get_url().'/js/mediaelement-and-player.min.js', $dependence, SHAREONEDRIVE_VERSION);
        wp_register_script('ShareoneDrive.Basic_Playlist.Player', $this->get_url().'/js/Player.js', ['Basic_Playlist.Polyfill', 'Basic_Playlist.Library', 'WPCloudplugin.Libraries'], SHAREONEDRIVE_VERSION, true);

        wp_enqueue_script('ShareoneDrive.Basic_Playlist.Player');
        ...
        wp_localize_script('ShareoneDrive.Basic_Playlist.Player', 'Default_Skin_vars', $localize_mediaplayer);
    }
    ...
    public function load_styles()
    {
        ...
        wp_register_style('ShareoneDrive.Basic_Playlist.Player.CSS', $this->get_url().'/css/style'.$is_rtl_css.'.css', false, SHAREONEDRIVE_VERSION);
        wp_enqueue_style('ShareoneDrive.Basic_Playlist.Player.CSS');
    }
}
