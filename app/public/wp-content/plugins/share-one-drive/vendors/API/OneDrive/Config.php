...
class SODOneDrive_Config
{
    ...
    /**
     * Create a new SODOneDrive_Config. Can accept an ini file location with the
    ...
    public function __construct($ini_file_location = null)
    {
        $this->configuration = [
            ...
            'application_name' => 'WPCloudPlugins|ShareoneDrive/'.SHAREONEDRIVE_VERSION,

            // Which Authentication, Storage and HTTP IO classes to use.
            'auth_class' => 'SODOneDrive_Auth_OAuth2',
            'io_class' => 'SODOneDrive_IO_Curl',
            'cache_class' => 'SODOneDrive_Cache_File',
            'logger_class' => 'SODOneDrive_Logger_Null',

            // Don't change these unless you're working against a special development
            // or testing environment.
            'base_path' => 'https://graph.microsoft.com',

            // Definition of class specific values, like file paths and so on.
            'classes' => [
                'SODOneDrive_IO_Abstract' => [
                    'request_timeout_seconds' => 100,
                ],
                'SODOneDrive_Logger_Abstract' => [
                    'level' => 'debug',
                    'log_format' => "[%datetime%] %level%: %message% %context%\n",
                    'date_format' => 'd/M/Y:H:i:s O',
                    'allow_newlines' => true,
                ],
                'SODOneDrive_Logger_File' => [
                    'file' => 'php://stdout',
                    'mode' => 0640,
                    'lock' => false,
                ],
                'SODOneDrive_Http_Request' => [
                ...
                'SODOneDrive_Service_Exception' => [
                    'retry_map' => [
                        '500' => self::TASK_RETRY_ALWAYS,
                        '502' => self::TASK_RETRY_ALWAYS,
                        '503' => self::TASK_RETRY_ALWAYS,
                        '504' => self::TASK_RETRY_ALWAYS,
                        '429' => self::TASK_RETRY_ALWAYS,
                        '403' => self::TASK_RETRY_NEVER,
                        'rateLimitExceeded' => self::TASK_RETRY_ALWAYS,
                        'userRateLimitExceeded' => self::TASK_RETRY_ALWAYS,
                    ],
                ],
                'SODOneDrive_IO_Exception' => [
     ...
     * the hd values within an id token (@see SODOneDrive_Auth_LoginTicket) after sign
