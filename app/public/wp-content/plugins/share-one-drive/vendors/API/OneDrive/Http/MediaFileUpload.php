 ...
 * of sizable data.
 */
class SODOneDrive_Http_MediaFileUpload {
  ...
  SODOneDrive_Client $client, SODOneDrive_Http_Request $request, $mimeType, $data, $resumable = false, $chunkSize = false, $boundary = false
  ) {
    $this->client = $client;
  ...
  public function nextChunk($chunk = false) {
    ...
    if ($this->client->getClassConfig("SODOneDrive_Http_Request", "enable_gzip_for_uploads")) {
    ...
    if (201 == $code) {
      ...
      return SODOneDrive_Http_REST::decodeHttpResponse($response, $this->client);
    }
  }
  ...
  public function getResumeUri() {
    ...
    throw new SODOneDrive_Exception($error);
  }
