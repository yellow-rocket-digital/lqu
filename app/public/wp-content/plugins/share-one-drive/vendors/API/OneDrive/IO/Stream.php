...
/**
 * Http Streams based implementation of SODOneDrive_IO.
 *
...
class SODOneDrive_IO_Stream extends SODOneDrive_IO_Abstract
{
  ...
  public function executeRequest(SODOneDrive_Http_Request $request)
  {
    ...
    if ($this->trappedErrorNumber) {
      ...
      throw new SODOneDrive_IO_Exception($error, $this->trappedErrorNumber);
    }
    ...
    if (false === $response_data) {
      ...
      $this->client->getLogger()->error('Stream ' . $error);
      throw new SODOneDrive_IO_Exception($error, $respHttpCode);
    }
