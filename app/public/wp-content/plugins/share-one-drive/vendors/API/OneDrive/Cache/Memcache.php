 ...
 */
class SODOneDrive_Cache_Memcache extends SODOneDrive_Cache_Abstract
{
  ...
  public function __construct(SODOneDrive_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new SODOneDrive_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws SODOneDrive_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new SODOneDrive_Cache_Exception("Couldn't store data in cache");
    }
