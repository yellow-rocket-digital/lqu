 ...
 */
class SODOneDrive_Logger_Psr extends SODOneDrive_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(SODOneDrive_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
