...
<p><?php esc_html_e('Need Marketing Insight? ,','wp-woocommerce-quickbooks')?> <a href="<?php echo esc_attr($plugin_url) ?>&section=vxc_premium"><?php esc_html_e('Go Pro!','wp-woocommerce-quickbooks')?></a></p>
</div>
 <?php
 return;
 }
...
if(!$html_added){
   ?> 
   <h3 style="text-align: center;"><?php esc_html_e('No Information Available','wp-woocommerce-quickbooks')?></h3>
   <?php
return;
}
