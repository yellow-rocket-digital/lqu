...
! defined( 'YITH_WAPO_VERSION' ) && define( 'YITH_WAPO_VERSION', '3.11.0' );
! defined( 'YITH_WAPO_SCRIPT_VERSION' ) && define( 'YITH_WAPO_SCRIPT_VERSION', '3.11.0' );
! defined( 'YITH_WAPO_DB_VERSION' ) && define( 'YITH_WAPO_DB_VERSION', '3.2.0' );
