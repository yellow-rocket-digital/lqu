...
<div class="fields">
	...
	<div class="field-wrap">
		...
		<div class="field">
			...
			<input type="text" name="options[start_year][]" id="option-start-year" value="<?php echo esc_attr( $addon->get_option( 'start_year', $x, '', false ) ); ?>" class="mini">
		</div>
		<div class="field">
			<small><?php echo esc_html__( 'END YEAR', 'yith-woocommerce-product-add-ons' ); ?></small>
			<input type="text" name="options[end_year][]" id="option-end-year" value="<?php echo esc_attr( $addon->get_option( 'end_year', $x, '', false ) ); ?>" class="mini">
		</div>
	</div>
	<!-- End option field -->
	...
	<!-- Option field -->
	<div class="field-wrap option-date-default-day option-date-default-day-<?php echo esc_attr( $x ); ?>" style="<?php echo $addon->get_option( 'date_default', $x, '', false ) !== 'specific' ? 'display: none;' : ''; ?>">
	...
	<!-- Option field -->
	<div class="field-wrap option-date-default-interval option-date-default-interval-<?php echo esc_attr( $x ); ?>" style="<?php echo $addon->get_option( 'date_default', $x, '', false ) !== 'interval' ? 'display: none;' : ''; ?>">
